...
BP_PHOTOS = "SELECT id, username, tg_id, desc, file_link from best_practice_mr"
...
async def change_bp(value: str) -> str:
    return f"UPDATE best_practice SET {value} = ? WHERE name = ?"
